...
const BACKGROUND_ROTATION_INTERVAL = 10000; // 10 seconds

// Backgrounds: Use official safe URLs or local paths
const backgrounds = [
  'https://webstatic.hoyoverse.com/upload/content/2024/04/12/4b5f3e70712621764161865562747550_3998653403821926141.jpg', // Official Arlecchino Key Visual
  'https://web-static.kurogames.com/resource/prod/wutheringwaves/website/static/kv.6e323f27.jpg' // Official WuWa Key Visual
];
